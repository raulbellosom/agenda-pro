            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4 flex-1 min-w-0">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  onClick={() => logoUrl && setShowImageViewer(true)}
                  className="w-12 h-12 rounded-xl overflow-hidden ring-2 ring-[rgb(var(--border-base))] hover:ring-[rgb(var(--brand-primary))] transition-all shrink-0"
                  title={logoUrl ? "Click para ver en grande" : group.name}
                  style={{ cursor: logoUrl ? "zoom-in" : "default" }}
                >
